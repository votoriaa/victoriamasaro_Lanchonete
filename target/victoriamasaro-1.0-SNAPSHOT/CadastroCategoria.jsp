...
<body>
    <div class="page-container">
        <div class="content">
            ...
            <form id="cadastroForm" method="get" action="${pageContext.request.contextPath}${URL_BASE}/CategoriaControlador">
                <input type="hidden" name="codCategoria" value="${codCategoria}" />
                <input type="hidden" name="opcao" value="${opcao}" />

                <div class="form-group">
                    <label for="nome">Nome:</label>
                    <input type="text" id="nome" required name="nome" value="${nome}" />
                </div>

                <div class="form-buttons">
                    <input type="submit" class="btn-salvar" value="Salvar" name="btnSalvar" />
                    <a href="${pageContext.request.contextPath}${URL_BASE}/CategoriaControlador?opcao=cancelar" class="btn-cancelar">Cancelar</a>
                </div>
            </form>
                    ...
                    <tbody>
                        <c:forEach var="categoria" items="${listaCategoria}">
                            <tr>
                                ...
                                <td>
                                    <form method="get" action="${pageContext.request.contextPath}${URL_BASE}/CategoriaControlador" style="display:inline;">
